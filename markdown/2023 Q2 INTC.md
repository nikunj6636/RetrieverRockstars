...
|Patent settlement|A portion of the charge from our IP settlements represents a catch-up of cumulative amortization that would have been incurred for the right to use the related patents in prior periods.|We exclude the catch-up charge related to prior periods for purposes of calculating certain non-GAAP measures because this adjustment facilitates comparison to past operating results and provides a useful evaluation of our current operating performance.|
...
|Exhibit Number|Exhibit Description|Form|File Number|Exhibit Date|Filed or Furnished|
|---|---|---|---|---|---|
...
|10.1†|Intel Corporation 2006 Equity Incentive Plan, as amended and restated effective May 11, 2023| | | |X|
...
|Date: July 27, 2023|By: /s/ SCOTT GAWEL|
...
2. Effective January 1, 2020, Section 8(b) of the Plan is amended to read, in its entirety, as follows:
...
3. Effective January 1, 2020, a new Section 9(k) is added to read as follows:
...
Havilah Gebhart Secretary, Management Retirement Plans Administrative Committee
# Exhibit 31.1
